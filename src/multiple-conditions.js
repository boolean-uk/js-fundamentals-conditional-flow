...
if (NUM >= LOWER && NUM <= UPPER) answerOne = true
...
if (STR === 'Hello' || STR === 'Goodbye') answerTwo = true
...
else if (AGE <= 4) answerThree = 'Toddler'
else if (AGE <= 12) answerThree = 'Child'
else if (AGE <= 19) answerThree = 'Teenager'
