...
const answerOne = NUM <= UPPER && NUM >= LOWER
...
if (AGE >= 1 && AGE >= 4) answerThree = 'Toddler'
if (AGE >= 5 && AGE >= 12) answerThree = 'Child'
if (AGE >= 13 && AGE >= 19) answerThree = 'Teenager'
if (AGE >= 20) answerThree = 'Adult'
