...
let answerFour = STR_FIVE.charAt(0).toLowerCase() === STR_FIVE.charAt(STR_FIVE.length-1).toLowerCase()
...
let answerFive = STR_SIX.charAt(0).toLowerCase() === STR_SIX.charAt(STR_SIX.length-1).toLowerCase()
...
let answerSix = STR_SEVEN.length % 2 === 0 ? false : STR_SEVEN[Math.floor(STR_SEVEN.length / 2)]
// 7. Use conditional statements to set answerSeven to the middle two characters of
// STR_EIGHT if STR_EIGHT has an even number of characters
const STR_EIGHT = 'Alex' // eslint-disable-line no-unused-vars

let answerSeven = STR_EIGHT.length % 2 === 0 ? STR_EIGHT.substring(STR_EIGHT.length / 2 - 1, STR_EIGHT.length / 2 + 1) : false
