...
const answerFive =
  ...
  STR_SIX.charAt(STR_FIVE.length - 1).toLowerCase()
...
if (STR_EIGHT.length % 2 === 0) {
  const middleIndex = Math.floor(STR_EIGHT.length / 2)
  answerSeven =
    STR_EIGHT.charAt(middleIndex - 1) + STR_EIGHT.charAt(middleIndex)
}
...
if (summer.includes(MONTH)) answerEight = 'Summer'
if (autumn.includes(MONTH)) answerEight = 'Autumn'
if (winter.includes(MONTH)) answerEight = 'Winter'
