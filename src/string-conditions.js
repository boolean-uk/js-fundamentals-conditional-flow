...
const answerFour =
  STR_FIVE[0].toLocaleUpperCase() ===
  STR_FIVE[STR_FIVE.length - 1].toLocaleUpperCase()
...
const answerFive =
  STR_SIX[0].toLocaleUpperCase() ===
  STR_SIX[STR_SIX.length - 1].toLocaleUpperCase()
...
if (STR_EIGHT.length % 2 === 0) {
  ...
  answerSeven = STR_EIGHT.substring(midIndex - 1, midIndex + 1)
}
...
switch (MONTH) {
  ...
  case 'November':
    ...
    break
  default:
    answerEight = 'Winter' // Covers December, January, and February
}
