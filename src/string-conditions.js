...
let answerSix = STR_SEVEN.length % 2 != 0 ? STR_SEVEN[Math.floor(STR_SEVEN.length / 2)] : null

// 7. Use conditional statements to set answerSeven to the middle two characters of
// STR_EIGHT if STR_EIGHT has an even number of characters
const STR_EIGHT = 'Alex' // eslint-disable-line no-unused-vars

let answerSeven = STR_EIGHT.length % 2==0 ? STR_EIGHT[(STR_EIGHT.length -2) / 2] +  STR_EIGHT[Math.ceil((STR_EIGHT.length-1) / 2)]  : null 
