...
let answerThree
if (STR_THREE > STR_FOUR) answerThree = true
...
let answerFour
if (STR_FIVE.toLowerCase()[0] === STR_FIVE.toLowerCase().slice(-1))
  answerFour = true
...
let answerFive
if (STR_SIX.toLowerCase()[0] === STR_SIX.toLowerCase()[-1]) answerFive = true
...
if (STR_EIGHT.length % 2 === 0)
  answerSeven =
    STR_EIGHT[parseInt(STR_EIGHT.length / 2) - 1] +
    STR_EIGHT[parseInt(STR_EIGHT.length / 2)]
