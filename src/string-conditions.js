...
let answerFour = STR_FIVE.charAt(0).toLowerCase() === STR_FIVE.charAt(STR_FIVE.length - 1).toLowerCase()? true : false
...
let answerFive = STR_SIX.charAt(0).toLowerCase() === STR_SIX.charAt(STR_SIX.length - 1).toLowerCase()? true : false
...
let answerSix = STR_SEVEN.length % 2 !== 0? STR_SEVEN.charAt(Math.floor(STR_SEVEN.length/2)):undefined
//let answerSix = STR_SEVEN.length % 2 === 0? STR_SEVEN.charAt(Math.floor(STR_SIX.length/2)) + STR_SEVEN.charAt(Math.floor(STR_SIX.length/2) + 1) :undefined
...
let answerSeven  =  STR_EIGHT.length % 2 === 0? STR_EIGHT.charAt(Math.floor(STR_EIGHT.length/2) - 1) + STR_EIGHT.charAt(Math.floor(STR_EIGHT.length/2)):undefined
