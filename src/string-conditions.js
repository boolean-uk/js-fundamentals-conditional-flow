...
const answerFour =
  STR_FIVE.toLowerCase()[0] === STR_FIVE.toLowerCase()[STR_FIVE.length - 1]
...
const answerFive =
  STR_SIX.toLowerCase()[0] === STR_SIX.toLowerCase()[STR_FIVE.length - 1]
...
const answerSix =
  STR_SEVEN.length % 2 === 1 ? STR_SEVEN[(STR_SEVEN.length - 1) / 2] : false
