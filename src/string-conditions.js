...
const str_five_lower = STR_FIVE.toLowerCase()

let answerFour = false
if(str_five_lower.endsWith(str_five_lower[0])){
  answerFour = true
}
...
const str_six_lower = STR_SIX.toLowerCase()

let answerFive = false
if(str_six_lower.endsWith(str_six_lower[0])){
  answerFive = false
}
...
if(STR_EIGHT.length % 2 === 0){
  let start_index = STR_EIGHT.length/2 - 1 
  answerSeven = STR_EIGHT.slice(start_index, start_index + 2)
}
