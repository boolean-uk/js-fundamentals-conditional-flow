...
let answerFour = STR_FIVE.toLocaleLowerCase().startsWith('a') && STR_FIVE.toLocaleLowerCase().endsWith('a')
...
let answerFive = STR_SIX.toLocaleLowerCase().startsWith('j') && STR_SIX.toLocaleLowerCase().endsWith('j')
...
if (spring.includes(MONTH)) answerEight = 'Spring'
else if (summer.includes(MONTH)) answerEight = 'Summer'
else if (autumn.includes(MONTH)) answerEight = 'Autumn'
else if (winter.includes(MONTH)) answerEight = 'Winter'
