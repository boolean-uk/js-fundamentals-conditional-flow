...
const answerFour = STR_FIVE.endsWith(STR_FIVE[0].toLocaleLowerCase())
...
const answerFive = STR_SIX.endsWith(STR_SIX[0].toLocaleLowerCase())
...
const answerSix =
  STR_SEVEN.length % 2 === 1 ? STR_SEVEN[STR_SEVEN.length / 2 - 0.5] : null
...
const answerSeven =
  STR_EIGHT.length % 2 === 0
    ? STR_EIGHT.substring(STR_EIGHT.length / 2 - 1, STR_EIGHT.length / 2 + 1)
    : null
